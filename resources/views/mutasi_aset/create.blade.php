                    ...
                    <form action="{{ route('mutasi_aset.store') }}" method="POST">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="tanggal_mutasi"
                                        ...
                                        id="tanggal_mutasi" value="{{ old('tanggal_mutasi') }}" required>
                                    ...
                                    <select name="lokasi_asal_id"
                                        ...
                                        @foreach ($lokasis as $lokasi)
                                            <option value="{{ $lokasi->id }}"
                                                {{ old('lokasi_asal_id') == $lokasi->id ? 'selected' : '' }}>
                                                {{ $lokasi->nama_lokasi }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="lokasi_tujuan_id"
                                        ...
                                        @foreach ($lokasis as $lokasi)
                                            <option value="{{ $lokasi->id }}"
                                                {{ old('lokasi_tujuan_id') == $lokasi->id ? 'selected' : '' }}>
                                                {{ $lokasi->nama_lokasi }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="keterangan" class="form-control @error('keterangan') is-invalid @enderror" id="keterangan"
                                rows="4" placeholder="Opsional">{{ old('keterangan') }}</textarea>
                            @error('keterangan')
                                <span class="invalid-feedback d-block">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Catat Mutasi
                            </button>
                        </div>
                    </form>
                </div>
